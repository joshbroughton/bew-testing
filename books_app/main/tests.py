...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        post_data = {
            'name': 'Leo Tolstoy',
            'biography': '''Count Lev Nikolayevich Tolstoy, usually referred to in English as 
        ...
        new_author = Author.query.filter_by(name='Leo Tolstoy').one()
        self.assertEqual(new_author.name, 'Leo Tolstoy')
        self.assertEqual(new_author.biography, '''Count Lev Nikolayevich Tolstoy, usually referred to in English as 
            Leo Tolstoy, was a Russian writer who is regarded as one of the greatest authors of all time.''')
    ...
    def test_create_genre(self):
        ...
        new_genre = Genre.query.filter_by(name='Science Fiction').one()
        self.assertEqual(new_genre.name, 'Science Fiction')
    ...
    def test_favorite_book(self):
        ...
        book_1 = Book.query.filter_by(id=1).one()
        user = User.query.filter_by(username='me1').one()
        self.assertIn(book_1, user.favorite_books)
    ...
    def test_unfavorite_book(self):
        ...
        book_1 = Book.query.filter_by(id=1).one()
        user = User.query.filter_by(username='me1').one()
        self.assertNotIn(book_1, user.favorite_books)
